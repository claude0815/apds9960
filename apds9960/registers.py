...
DEFAULT_GPENTH = 5        # Gesture entry threshold (very low for reduced gain)
DEFAULT_GPEXTH = 3        # Gesture exit threshold
DEFAULT_GCONF1 = 0x40     # 4 gesture events for interrupt, 1 event per fifo
DEFAULT_GCONF2 = 0x09     # Gain 1x, LED drive 50mA, 8us gesture wait
DEFAULT_GPULSE = 0x85     # 16us, 6 pulses
DEFAULT_GOFFSET_U = 0x80  # -128: compensate UP saturation
DEFAULT_GOFFSET_D = 0
DEFAULT_GOFFSET_L = 0
DEFAULT_GOFFSET_R = 0
